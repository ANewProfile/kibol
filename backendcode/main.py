...
CORS(app, resources={
    r"/tossup": {"origins": "http://127.0.0.1:5500, https://anewprofile.github.io"},
    r"/bonus": {"origins": "http://127.0.0.1:5500, https://anewprofile.github.io"},
    r"/checkanswer": {"origins": "http://127.0.0.1:5500, https://anewprofile.github.io"},
    r"/checkroomexists": {"origins": "http://127.0.0.1:5500, https://anewprofile.github.io"}
})
...
@cross_origin(origin='http://127.0.0.1:5500, https://anewprofile.github.io',headers=['Content-Type','Authorization'])
def tossup():
